...
//           </button>
//           <button className="bg-green-500 hover:bg-green-700 text-white font-bold p-2 pl-3 rounded">
//             Export
//           </button>
//           <button className="bg-red-500 hover:bg-red-700 text-white font-bold p-2 pl-3 rounded">
//             Delete
//           </button>
//           {showEditDeleteButtons && (
//             <button className="bg-yellow-500 hover:bg-yellow-700 text-white font-bold p-2 pl-3 rounded">
//               Edit
//             </button>
//           )}
//         </div>
...
//                   <td className="  p-2 ">:</td>
//                   <td>&nbsp; &nbsp; </td>
//                   {/*<td className="text-blue-500 p-2 border border-gray-400 w-[50%] max-w-full break-words ">{teams.join(", ")}</td>*/}
//                   <td className="text-blue-500 p-2 border border-gray-400 w-[50%] max-w-full break-words ">{"N/A"}</td>
//                 </tr>
//                 <tr>
...
//               <table className="table-auto -collapse  w-full rounded-xl">
//                 <tbody>
//                   <tr>
//                     <td
//                       colSpan={7}
...
//                   </tr>
//                   <tr>
//                     <td className=" p-2 bg-blue-200 font-semibold ">
//                       Milestones{" "}
//                     </td>
