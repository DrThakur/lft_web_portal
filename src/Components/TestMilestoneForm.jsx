...
const TestMilestoneForm = ({
  ...
  // state for displayinh milestone object
  //   const [milestone, setMilestone]=useState({milestoneName,plannedStartDate, plannedEndDate, invoiceValue, description});
  ...
  const handleSaveMilestone = () => {
    ...
    // addMilestones(milestoneDetails);

    // Update milestone details state
    const updatedMilestoneDetails = [...milestoneDetails, newMilestone];
    setMilestoneDetails(updatedMilestoneDetails);

    // Pass the updated milestone details to the parent component
    if (addMilestones) {
      addMilestones(updatedMilestoneDetails);
    }
  ...
  console.log("my deatils of milestone in milestoneform", milestoneDetails);

  return (
    <div>
      <h2 className="text-xl font-semibold mb-4">Milestone Form</h2>
      <div className="grid grid-cols-4 gap-4 md:grid-cols-1 lg:grid-cols-2 xl:grid-cols-1">
        <div className="mb-4">
          <label
...
export default TestMilestoneForm;
