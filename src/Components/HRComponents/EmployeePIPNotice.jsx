  ...
  return (
    <div className="p-6 bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-500 text-white shadow-xl rounded-xl max-h-96 min-h-96">
      ...
      <div
        ...
        className={` max-h-64 transition-all duration-300 overflow-y-auto lg:overflow-y-hidden lg:hover:overflow-y-auto  scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-white`}>
