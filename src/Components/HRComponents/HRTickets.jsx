...
const HRTickets = ({data}) => {
  ...
  return (
    <div className="p-6 bg-gradient-to-r from-teal-200 to-green-300 text-white shadow-lg rounded-lg max-h-96 min-h-96">
      ...
      <ul 
        className={`space-y-3  max-h-72 transition-all duration-300 overflow-y-auto lg:overflow-y-hidden lg:hover:overflow-y-auto  scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-white`}
