...
const QuickAccess = () => {
  return (
    <div className="p-4 w-full bg-white rounded-lg shadow-lg max-h-96 min-h-96">
      <div>
        <h3 className=" text-base sm:text-lg md:text-2xl font-bold mb-4 bg-yellow-100 py-2 px-3 rounded-lg">
          Quick Access
        </h3>
        {/* Quick Access List */}
        <ul className="min-h-64 max-h-64 flex flex-col justify-start items-start w-full space-y-3 overflow-y-auto lg:overflow-y-hidden hover:overflow-y-auto transition-all duration-300 
