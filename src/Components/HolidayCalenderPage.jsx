...
//   // Get the current date and set the time to midnight (to avoid issues with time comparison)
...
//     const holidayDate = new Date(currentYear, holiday.month - 1, holiday.day); // Use the current year, holiday month and day
//     holidayDate.setHours(0, 0, 0, 0); // Set to midnight for accurate comparison

//     // Return holidays that are today or in the future
