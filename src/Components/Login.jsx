  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 h-screen w-auto">
      ...
      {isImageVisible && (
        <div className="bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center m-4 rounded-md">
          <div className="relative flex justify-center items-center w-full h-full">
            ...
            <div className="flex justify-center mt-2 absolute bottom-20 w-full">
              {images.map((_, index) => (
                <button
                  key={index}
      ...
      <div className="flex items-center justify-center px-4 lg:px-0">
        <div className="w-full lg:w-3/5 h-auto md:h-[96%] bg-white p-6 md:p-10 rounded-xl shadow-2xl my-3">
          <div className="w-full mt-0 lg:mt-4 flex justify-center">
            <img src={logo} alt="Logo" className="h-56 w-56 cursor-pointer" />
          </div>
          <div className="text-3xl font-bold mb-6 text-center -mt-8 flex items-center">
            <hr className="flex-grow border-t-2 border-blue-400 rounded-lg shadow-md mb-4 mt-4" />
          ...
          <form>
            ...
            <div className="mb-4">
              <label className="block mb-4 text-2xl font-bold" htmlFor="password">
                Password
              </label>
              <div className="relative">
                <input
            ...
            <button
              ...
              disabled={isFetching || loading}
              onClick={handleSignin}
              className={`w-full py-3 rounded-md text-2xl ${isFetching || loading
                  ? "bg-red-300 cursor-not-allowed"
                  : "bg-blue-500 text-white hover:bg-blue-600"
                }`}
            >
