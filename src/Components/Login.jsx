...
//       <div className="w-full md:w-1/2 bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center p-4 rounded-md">
...
//         <div className="w-full max-w-lg bg-white p-6 md:p-10 rounded-xl shadow-2xl">
//           <div className="flex justify-center mb-6">
//             <img src={logo} alt="Logo" className="h-20 w-20 cursor-pointer" />
//           </div>

//           <div className="text-3xl font-bold mb-6 text-center flex items-center">
//             <hr className="flex-grow border-t-2 border-blue-400 rounded-lg shadow-md mb-4 mt-4" />
//             <span className="px-4">Web Portal</span>
//             <hr className="flex-grow border-t-2 border-blue-400 rounded-lg shadow-md mb-4 mt-4" />
//           </div>
...
//                 autoComplete="email"
//                 required
//                 className="w-full px-4 py-3 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-500 text-xl"
//               />
//             </div>
...
//                 <button
//                   type="button"
//                   className="absolute top-1/2 right-2 transform -translate-y-1/2 text-gray-500 focus:outline-none text-xl"
//                   onClick={togglePasswordVisiblity}
//                 >
//                   {passwordShown ? <FaEye /> : <FaEyeSlash />}
//                 </button>
...
//               disabled={isFetching || loading}
//               onClick={handleSignin}
//               className={`w-full py-3 rounded-md text-xl ${
//                 isFetching || loading
//                   ? "bg-red-300 cursor-not-allowed"
//                   : "bg-blue-500 text-white hover:bg-blue-600"
//               }`}
