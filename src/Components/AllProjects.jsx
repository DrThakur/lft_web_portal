...
const AllProjects = () => {
  ...
  // this is for Update the scrollHeight dynamically based on the window height or container
  useEffect(() => {
    const handleResize = () => {
  ...
  return (
      ...
      >
        <div className="field">
          ...
          <InputText
            ...
            required
            autoFocus
            className={classNames({ "p-invalid": submitted && !project.projectName })}
          />
          {submitted && !project.projectName && (
            <small className="p-error">Project Name is required.</small>
          )}
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
          <div className="field w-full">
            ...
            <Calendar
              ...
              onChange={(e) => onInputChange(e, "plannedStartDate")}
              dateFormat="dd/M/yy"
            />
          </div>
          <div className="field w-full">
            ...
            <Calendar
              ...
              onChange={(e) => onInputChange(e, "plannedEndDate")}
              dateFormat="dd/M/yy"
            />
          </div>
        </div>
        ...
        <div className="field col">
          ...
          <FinalEmployeeDropdown
            ...
            onChange={(e) => onInputChange(e, "projectManager")}
          />
        </div>
        ...
        <div className="field">
          ...
          <InputText
            ...
            required
            className={classNames({ "p-invalid": submitted && !project.client })}
          />
          {submitted && !project.client && (
            <small className="p-error">Client is required.</small>
          )}
        </div>
        ...
        <div className="field">
          ...
          <InputText
            ...
            required
            className={classNames({ "p-invalid": submitted && !project.contactPerson })}
          />
          {submitted && !project.contactPerson && (
    ...
    required
    className={classNames({ "p-invalid": submitted && !project.status })}
  />
