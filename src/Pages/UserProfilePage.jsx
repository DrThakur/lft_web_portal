 ...
 const initialSkills = userDetails.techSkills;
  ...
  return (
    <div className="bg-white p-2 h-screen w-full mt-2 overflow-y-auto border rounded-lg shadow-lg">
      ...
      <div className="main Container flex flex-col">
        {/* Profile Section */}
        <div className="profile-container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 rounded-lg shadow-md p-4 mt-4">
          <div className="profile-image-section flex flex-col items-center justify-start">
            <img
              src="https://static.vecteezy.com/system/resources/thumbnails/002/002/403/small/man-with-beard-avatar-character-isolated-icon-free-vector.jpg"
              alt="userImage"
              width={150}
            ...
            />
            <button
              className="edit-button mt-2 text-blue-500 rounded-full bg-gray-100 shadow-lg hover:bg-blue-500 hover:text-white p-2 hover:cursor-pointer"
              onClick={handleEditClick}
            >
              <label htmlFor="file-upload">
                <MdModeEdit />
          ...
          <div className="profile-info-section flex flex-col justify-start items-start gap-2">
            <p className="text-xl font-bold">
              {user.fullName || "Ankit Kumar Thakur"}
            </p>
            <p className="text-gray-400">{user.designation || "R&D Engineer"}</p>
            <p className="text-gray-400">{user.location || "Gurgaon"}</p>
            <p className="text-gray-400">{user.department || "Software Department"}</p>
            ...
            <button className="message-button mt-4 flex items-center gap-2 p-2 px-6 bg-blue-500 hover:bg-blue-700 text-white rounded shadow">
              <BsFillSendFill />
              Send Message
            </button>
          </div>
          ...
          <div className="contact-info-section mt-4 md:mt-0">
        ...
        {/* Actions Section */}
        <div className="actions-section mt-6 flex flex-wrap gap-4 justify-start">
          <button className="action-btn bg-yellow-300 hover:bg-yellow-500 p-2 px-6 rounded shadow text-white">
            Send Reset Password Link
          </button>
          <button className="action-btn bg-red-300 hover:bg-red-500 p-2 px-6 rounded shadow text-white">
            Reset Password
          </button>
        </div>
        ...
        <TabView className="mt-6">
          <TabPanel header="My Education">
            <Timeline value={events} content={customizedContent} />
          </TabPanel>
          <TabPanel header="My Experience">
            <Timeline value={experienceEvents} content={customizedContentExperience} />
          </TabPanel>
          <TabPanel header="My Projects">
            <ProjectCarousel />
          </TabPanel>
          <TabPanel header="My Skills">
            <MySkills skills={initialSkills} />
          </TabPanel>
        </TabView>
      </div>
    </div>
